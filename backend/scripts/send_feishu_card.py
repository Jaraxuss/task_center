...
Examples:
  python backend/scripts/send_feishu_card.py --markdown report.md --dry-run
  python backend/scripts/send_feishu_card.py --text "提醒：测试" --to ou_xxx
...
from services.feishu_card import (  # noqa: E402
    FeishuCardClient,
    FeishuTarget,
    markdown_to_card_v2,
    text_to_card_v2,
